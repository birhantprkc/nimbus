...
<PackageManagers pkg="@cloudflare/nimbus-docs" type="dlx" args="add new-version" comment="inside a coding agent, the recipe pipes straight in" />
<PackageManagers pkg="@cloudflare/nimbus-docs" type="dlx" args="add new-version --print | claude" comment="from a human shell, hand it to the agent of your choice" />
